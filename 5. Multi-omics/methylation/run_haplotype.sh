...
bismark --bowtie2  --bam -p 40 -o prem_leaf  ./genome/  -1 ./B48_ZG_merge_WGBS_data/B48-prem-L.R1.fastq.gz   -2 ./B48_ZG_merge_WGBS_data/B48-prem-L.R2.fastq.gz
samtools sort -@ 40  B48-m-L.R1_bismark_bt2_pe.bam  -o B48-m-L.R1_bismark_bt2_pe.sort.bam
samtools sort -@ 40  B48-m-S.R1_bismark_bt2_pe.bam  -o B48-m-S.R1_bismark_bt2_pe.sort.bam 
samtools sort -@ 40  B48-prem-L.R1_bismark_bt2_pe.bam   -o B48-prem-L.R1_bismark_bt2_pe.sort.bam 
